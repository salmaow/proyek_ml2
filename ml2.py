...
- Tampilan dari beberapa baris pertama ini disatukan menjadi userId, bookIndex, dan Boook Name agar mudah dipanggil.
...
min_ratings_book = 5 # pakai threshold
...
"""- Hasil dari penerapan model Singular Value Decomposition (SVD) untuk sistem rekomendasi, kemungkinan besar menggunakan pendekatan collaborative filtering. Setelah model SVD dilatih, kinerjanya dievaluasi menggunakan metrik RMSE sebesar 1.4531 dan MAE sebesar 1.2536, yang mengindikasikan tingkat kesalahan prediksi rating.
...
if not books_cb_sample.empty:
    ...
    try:
        ...
        recommendations_simple = get_content_based_recommendations_sample(bookindex_to_test_simple, N=10)
